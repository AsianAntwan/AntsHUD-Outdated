...
Scheme
{
	...
	BaseSettings
	{
		...
		CheckButton.BgColor				"AntsHUDGrey"
		...
		Menu.ArmedFgColor		"AntsHUDGrey"
		Menu.ArmedBgColor		"AntsHUDWhite"
		Menu.DividerColor		"Border.Dark"
		
		ScrollBarButton.FgColor				"AntsHUDWhite"
		ScrollBarButton.BgColor				"AntsHUDGrey"
		ScrollBarButton.ArmedFgColor		"AntsHUDGrey"
		ScrollBarButton.ArmedBgColor		"AntsHUDWhite"
		ScrollBarButton.DepressedFgColor	"AntsHUDGrey"
		ScrollBarButton.DepressedBgColor	"AntsHUDWhite"

		ScrollBarSlider.BgColor				"AntsHUDGrey"		// this isn't really used
		...
		ListPanel.SelectedTextColor			"AntsHUDGrey"
		...
		RichText.SelectedTextColor		"AntsHUDGrey"
		...
		SectionedListPanel.DividerColor			"AntsHUDGrey"
		SectionedListPanel.TextColor			"DullWhite"
		SectionedListPanel.BrightTextColor		"AntsHUDWhite"
		SectionedListPanel.BgColor				"HudBlack"
		SectionedListPanel.SelectedTextColor			"AntsHUDGrey"
		SectionedListPanel.SelectedBgColor				"AntsHUDWhite"
		SectionedListPanel.OutOfFocusSelectedTextColor	"AntsHUDGrey"
		...
		TextEntry.SelectedTextColor				"AntsHUDGrey"
		TextEntry.OutOfFocusSelectedBgColor		"100 100 100 128"
		TextEntry.FocusEdgeColor				"0 0 0 196"
		
		ToggleButton.SelectedTextColor		"AntsHUDWhite"
		
		Tooltip.TextColor		"AntsHUDGrey"
	...
	Borders
	{
		...
		TabBorder
		{
			...
			render 
			{
				"0" "fill( x0, y0, x1, y1, AntsHUDGrey )"
			}
